...
export const PROJECT_CARD_STYLES = {
  // Container styles
  container: {
    base: 'group relative flex flex-col overflow-hidden rounded-2xl border border-zinc-200/70 bg-white shadow-sm transition-all duration-200 dark:border-white/[0.08] dark:bg-[#0b0e14]/70',
    hover: 'hover:border-zinc-300 hover:shadow-md dark:hover:border-white/[0.12]',
    expanded: 'ring-1 ring-zinc-200/80 dark:ring-white/[0.08]',
  },
  ...
  // Header section
  header: {
    base: 'flex items-start gap-3 p-4',
  },
  ...
  // Task list container
  taskList: {
    base: 'border-t border-zinc-100/80 px-4 pb-4 pt-3 space-y-2 dark:border-zinc-700/40',
  },
