      ...
      <Card className="flex flex-col overflow-hidden rounded-3xl">
        ...
        <AnimatePresence initial={false}>
          {!isCollapsed && (
            ...
            >
              <div className="px-6 py-4 no-select-calendar sm:px-5 sm:py-5 md:px-6">
                ...
                <div className="relative">
                  ...
                  <div className="flex md:grid md:grid-cols-5 gap-8 overflow-x-auto pb-2 snap-x snap-mandatory scrollbar-hide -mx-6 px-6 md:mx-0 md:px-0 md:overflow-visible md:pb-0">
